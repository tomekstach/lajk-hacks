...
div#<?php echo $id; ?> ul.maximenuck li span.separator span {
	font-size: 13px;
	font-style: italic;
	color: #fbe5b1;
	font-family: 'Arno';
...
@media (max-width: 767px) {
	...
	div#<?php echo $id; ?> ul.maximenuck li.maximenuck a, div#<?php echo $id; ?> ul.maximenuck li.maximenuck span.separator {
		display: block;
		float: none;
		font-size: 16px;
		margin-left: auto;
	...
	div#<?php echo $id; ?> ul.maximenuck li.maximenuck a, div#<?php echo $id; ?> ul.maximenuck li.maximenuck span.separator {
		...
		color: #2a2727;
		display: block;
		background: url(../images/menu_podswietl_mobile.png) 0 60px repeat-x;
		width: 160px;
		height: 23px;
		text-align: center;
		padding-top: 38px;
	}
	div#<?php echo $id; ?> ul.maximenuck li.maximenuck a span, div#<?php echo $id; ?> ul.maximenuck li.maximenuck span.separator span {
		color: #2a2727;
		line-height: 30px;
	}
}
