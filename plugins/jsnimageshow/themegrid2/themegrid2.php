...
class plgJSNImageshowThemeGrid2 extends JPlugin
{
	var $_showcaseThemeName = 'themegrid2';
	var $_showcaseThemeType = 'jsnimageshow';
	var $_pathAssets 		= 'plugins/jsnimageshow/themegrid2/assets/';
