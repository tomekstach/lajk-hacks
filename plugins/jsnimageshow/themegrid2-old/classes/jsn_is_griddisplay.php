...
{
	var $_themename 	= 'themegrid2';
	var $_themetype 	= 'jsnimageshow';
	var $_assetsPath 	= 'plugins/jsnimageshow/themegrid2/assets/';
	...
	function standardLayout($args)
	{
		...
		foreach ($images as $image)
		{
			...
			$html .= '<span class="thumb_title">'.$image->title.'</span><br /><span class="thumb_desc">'.strip_tags(trim($image->description)).'</span>';
			$html .= '</a></div>';
		}
